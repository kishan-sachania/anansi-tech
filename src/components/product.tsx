    ...
    <>
      <section id="products" className="pb-10 px-4">
        <div className="container mx-auto max-w-6xl flex flex-col justify-center items-center">
          <div
            key={activeCategory}
            className={` w-1/2 hover:w-full hover:h-[600px]
          ...
          >
            {
              <Card
                ...
                onMouseEnter={() => {
                  setHoveredProduct(products.indexOf(product));
                  handleMouseEnter(products.indexOf(product));
                }}
                onMouseLeave={() => {
                ...
                <CardHeader className="pb-4">
                  <div className="flex items-center space-x-3 mb-4">
                    <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center group-hover:bg-primary/20 transition-colors duration-500">
                      <product.icon className="h-6 w-6 text-gray-500 group-hover:text-primary transition-colors duration-500" />
                    </div>
                                ...
                                (feature, featureIndex) => (
                                  <div key={featureIndex}>
                                    {typeof feature === "object" ? (
                                      <AnimatedMetric
                                        feature={feature}
                                        isHovered={hoveredProduct === products.indexOf(product)}
                                      />
                                    ) : (
                                      <div className="flex items-center space-x-3">
                                        <CheckCircle className="h-4 w-4 text-primary flex-shrink-0" />
